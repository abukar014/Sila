      ...
      <table className="w-full text-sm">
        <thead>
          <tr style={{ backgroundColor: '#111', borderBottom: '1px solid #2a2a2a' }}>
            ...
            <th className="text-left px-5 py-3 font-medium" style={{ color: '#666' }}>Faith Approach</th>
            <th className="text-left px-5 py-3 font-medium" style={{ color: '#666' }}>Accepting</th>
            <th className="text-left px-5 py-3 font-medium" style={{ color: '#666' }}>Verified</th>
            <th className="text-left px-5 py-3 font-medium" style={{ color: '#666' }}>Actions</th>
          </tr>
        </thead>
        <tbody>
          {providers.map((p, i) => (
            ...
            >
              <td className="px-5 py-4">
                ...
                {p.credentials && <p className="text-xs mt-0.5" style={{ color: '#555' }}>{p.credentials}</p>}
              </td>
              <td className="px-5 py-4" style={{ color: '#888' }}>{p.city ?? '—'}</td>
              <td className="px-5 py-4" style={{ color: '#888' }}>
              ...
              <td className="px-5 py-4">
                <div className="flex items-center gap-2">
                  <Link
                    ...
                    style={{ backgroundColor: '#222', color: '#aaa', border: '1px solid #333' }}
                  >
                    View profile
                  </Link>
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg text-xs font-medium transition-colors"
                    style={{ backgroundColor: '#2d0a0a', color: '#f87171', border: '1px solid #450a0a', opacity: deactivating === p.id ? 0.5 : 1 }}
                  >
